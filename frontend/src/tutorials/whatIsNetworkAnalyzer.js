...
export default new Tutorial({
  ...
  frames: [
    ...
    new Frame({
      ...
      text: 'With this application you can capture live packets, filter by protocol or IP address, inspect individual packet details layer by layer, and save captures for later analysis. Use the detail level setting to control how much detail is shown.',
      highlight: ['protocol-filter', 'ip-filter', 'level-selector'],
    }),
  ],
});
